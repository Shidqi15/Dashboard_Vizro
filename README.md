| Library                       | Fungsi                                                                                                             |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------ |
| **pandas**                    | Digunakan untuk membaca, mengolah, dan menganalisis data dari file CSV.                                            |
| **plotly**                    | Digunakan untuk membuat visualisasi data interaktif seperti bar chart, line chart, dan pie chart.                  |
| **dash**                      | Framework berbasis Flask yang digunakan untuk membangun dashboard web interaktif menggunakan Python.               |
